...
use App\Http\Controllers\OverallReportController; // Import OverallReportController
...
use App\Http\Controllers\LogoController; // Add LogoController import
...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    // Add Overall Report Route
    Route::get('/overall-report', [OverallReportController::class, 'index'])->name('overall-report.index');

    // Add Logo Route
    Route::get('/logo', [LogoController::class, 'index'])->name('logo.index'); // Add this line
