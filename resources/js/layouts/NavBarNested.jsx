...
export default function Sidebar() {
  ...
  useEffect(() => {
    setItems([
      ...
      // New "Overall Report" entry
      {
        label: "Overall Report",
        icon: IconListDetails, // Choose the icon that fits the purpose
        link: route("overall-report.index"), // Route defined for Overall Report
        active: route().current("overall-report.*"),
